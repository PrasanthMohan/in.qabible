...
public class ClientTestClass extends BaseClass {
	...
	public void verifyToCreateClient() throws IOException {
		...
		cc.createClient(
			cc.readStringData(9, 0),
			cc.readStringData(9, 1),
			fName,
			RandomDataUtilityClass.getFullAddress(),
			RandomDataUtilityClass.getPostCode(),
			cc.readStringData(9, 5),
			RandomDataUtilityClass.getRandomPhoneNumber(),
			RandomDataUtilityClass.getRandomEmail(),
			cc.readStringData(9, 8),
			cc.readStringData(9, 9),
			cc.readStringData(9, 10),
			cc.readStringData(9, 11),
			cc.readIntegerData(9, 12),
			cc.readStringData(9, 13)
			);
